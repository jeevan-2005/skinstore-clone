      ...
      toast({
        ...
        render: () => (
          ...
          >
            ...
            <Text size="lg" ml="15px">
              You have not Signed Out Successfully!!!
            </Text>
          </Flex>
        ),
      });
      ...
      <Box position={"fixed"} top="0px" zIndex={100} bgColor="white" w="100%">
        ...
        >
          ...
          >
            ...
            <div>
              <Link to="/latest">
                <div id="menu-title">Latest</div>
              </Link>
            </div>
            <div>
              <Link to="/admin">
                <div id="menu-title">Admin</div>
              </Link>
            </div>
          </Box>
        </Box>
              ...
              <DrawerContent>
                ...
                <DrawerBody>
                  <Box display="flex" flexDirection="column" gap="20px">
                    ...
                    <Link to="/holiday" onClick={onClose}>
                      Holiday Gif
                    </Link>
                    ...
                    <Link to="/hair" onClick={onClose}>
                      Hair Care
                    </Link>
                    <Link to="/makeup" onClick={onClose}>
                      Makeup
                    </Link>
                    <Link to="/bathbeauty" onClick={onClose}>
                      Bath & Body
                    </Link>
